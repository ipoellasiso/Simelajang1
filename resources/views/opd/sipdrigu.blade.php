    ...
    <li class="sidebar-menu-title">MENU</li>
          ...
          <li class="">
            ...
            <ul class="sidebar-submenu">
              ...
              <li>
                <a href="{{ route('spm') }}?id=1">Data SP2D LS SIPD RI</a>
              </li>
              <li>
                <a href="{{ route('pajakls') }}">Data Pajak LS</a>
              </li>
              <li>
                <a href="{{ route('sp2dgu') }}?id=1">Data SP2D GU SIPD RI</a>
              </li>
            </ul>
          </li>
                ...
                <div class=" space-y-5">
                  <div class="card">
                    <header class=" card-header noborder">
                      <h4 class="card-title">DATA SP2D GU SIPD RI
                      </h4>
                            ...
                            <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                              ...
                              <body>
                                <?php $i=1; 
                                      ...
                                      $page = $_GET['id'];
                                      // $nomordok = $_GET['id'];
                                      $token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..wHezoAshycC45kUTdkI_2WC5v7mihdBf0wFOPqIeLsc';
                                      $urlgu = "https://service.sipd.kemendagri.go.id/pengeluaran/strict/sp2d/pembuatan/index?jenis=GU&status=draft&page=$page&limit=10";
                                  ...
                                  <td class="table-td">{{ rupiah($row['nilai_sp_2_d']) }}</td>
                                            ...
                                            <td class="table-td ">
                                              <div class="flex space-x-3 rtl:space-x-reverse">
                                                  ...
                                                  <a href="{{ route('simpansp2dgu') }}?id=<?= $row['id_sp_2_d']; ?>" class="action-btn" type="button">
                              ...
                              <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                  ...
                                  <?php
                                    ...
                                    {
                                      ?>
                                      <li class="page-item"><a class="page-link" href="Sp2dgu?id=<?=$a;?>"><?=$a;?></a></li>
                                    <?php 
                                      }
                                    ?>
                                  <li class="page-item">
                                    <a class="page-link" href="Sp2dgu?id=<?=$a;?>" aria-label="Next">
